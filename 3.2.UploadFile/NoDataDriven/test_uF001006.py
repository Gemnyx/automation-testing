...
class TestUF001006():
  ...
  def test_uF001006(self):
    ...
    self.driver.find_element(By.NAME, "repo_upload_file").send_keys("/Users/duyanhle/Desktop/SoftwareTesting-Assignment3/UploadFile/sample-file/100-mb.txt")
