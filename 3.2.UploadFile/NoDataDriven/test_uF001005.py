...
class TestUF001005():
  ...
  def test_uF001005(self):
    ...
    self.driver.find_element(By.NAME, "repo_upload_file").send_keys("/Users/duyanhle/Desktop/SoftwareTesting-Assignment3/UploadFile/sample-file/99-mb.txt")
