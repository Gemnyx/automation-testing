...
class TestUF001007():
  ...
  def test_uF001007(self):
    ...
    self.driver.find_element(By.NAME, "repo_upload_file").send_keys("/Users/duyanhle/Desktop/SoftwareTesting-Assignment3/UploadFile/sample-file/101-mb.txt")
