...
class TestUF001003():
  ...
  def test_uF001003(self):
    ...
    self.driver.find_element(By.NAME, "repo_upload_file").send_keys("/Users/duyanhle/Desktop/SoftwareTesting-Assignment3/UploadFile/sample-file/two-byte.txt")
